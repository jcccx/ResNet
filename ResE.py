...
class ResEncoder(nn.Module):
    def __init__(self, block, kernel_size, num_classes=6, in_planes=10):  # block means BasicBlock
        ...
        self.layer1 = self._make_layer(block, kernel_size[0], 128)  # 128)
        self.layer2 = self._make_layer(block, kernel_size[1], 256)  # 256)
        self.layer3 = self._make_layer(block, kernel_size[2], 256)  # 512)
        self.layer4 = self._make_layer(block, kernel_size[3], 512)  # 512)
        #self.layer5 = self._make_layer(block, kernel_size[4], 512)  # 512)
